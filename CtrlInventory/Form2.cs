...
namespace CtrlInventory
{
    public partial class Form2 : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            precioSeleccionado = Convert.ToDecimal(selectedProduct["Precio"]);
        }
        ...
        private void LoadPurchasesData()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                SqlDataAdapter adapter = new SqlDataAdapter("select \r\nIdPurchase as CodigoCompra,\r\nPurchaseDate as FechaCompra,\r\nProducts.Descripcion as Produto,\r\nQuantity as Cantidad,\r\nInvoiceNumber as Factura,\r\nSerie\r\nfrom\r\nPurchases,\r\nProducts\r\nwhere\r\nPurchases.ProductId = Products.IdProducts;", connection);
        ...
        private void LoadProductsData()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string query1 = "SELECT IdMarca, Descripcion FROM Marca ORDER BY Descripcion ASC";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "EXEC [dbo].[sp_InsertPurchase] @IdProduct = @ProductId, @Quantity = @Quantity, @InvoiceNumber = @InvoiceNumber, @Serie = @Serie";
                    ...
                    MessageBox.Show("La compra se ha insertado correctamente. Número de factura: " + invoiceNumber + ", Serie: " + serie);
                    LoadPurchasesData(); // Actualizar los datos en el DataGridView
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string descripcionMarca = comboBox2.Text; // Obtener la descripción de la marca seleccionada
            ...
            string filePath = "C:\\Users\\anndy\\OneDrive\\Documentos\\comprobanteCompra.pdf";
            ...
            Paragraph paragraph = new Paragraph("COMPROBANTE DE COMPRA", FontFactory.GetFont(FontFactory.HELVETICA_BOLD, 12));
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("Marca"));
            ...
            table2.AddCell(descripcionMarca);
